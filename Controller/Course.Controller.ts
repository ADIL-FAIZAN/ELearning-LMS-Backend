...
router.get("/get-course/:id",async (req: Request, res: Response, next: NextFunction) => {
...
router.get("/get-courseDetail/:id",async (req: Request, res: Response, next: NextFunction) => {
...
router.get("/get-All-Courses-user", async (req: Request, res: Response, next: NextFunction) => {
...
router.get("/get-course-content/:id",UpdateAccessToken,isUserAuthenticated,async (req: Request, res: Response, next: NextFunction) => {
  
  try {
      
      const courseId = req.params.id;

      const userCoursesList = (req as any).user.courses;
      
      const validUserForCourseAccess = userCoursesList.find((e: any) => {
...
router.put("/add-question",UpdateAccessToken,isUserAuthenticated,async (req: Request, res: Response, next: NextFunction) => {
...
router.put("/add-answer",UpdateAccessToken ,isUserAuthenticated, async (req: Request, res: Response, next: NextFunction) => {
...
router.put("/add-review/:id",UpdateAccessToken,isUserAuthenticated,async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
     ...
     const validUserForGiveReview = userCoursesList.some((e: any) => {
...
router.put("/admin-review-reply",UpdateAccessToken,isUserAuthenticated,isAdmin,async (req: Request, res: Response, next: NextFunction) => {
  ...
  router.get("/get-all-courses",async (req: Request, res: Response, next: NextFunction) => {
...
router.delete("/delete-course/:id",UpdateAccessToken,isUserAuthenticated,isAdmin,async (req: Request, res: Response, next: NextFunction) => {
...
router.post("/get-videoCipher-otp",isUserAuthenticated,async (req: Request, res: Response, next: NextFunction) => {
